...
if __name__ == "__main__":
    signal, sr = librosa.load("/preproc/datasets/example_libri/input_1.wav")
    augmented_signal = add_white_noise(signal, 0.03)
    #augmented_signal = random_gain(signal)
    sf.write("/preproc/datasets/example_libri/output_1w.wav", augmented_signal, sr)
...
if __name__ == '__main__':
    ...
    for lang in LANGUAGES:
        get_manifest = GenerateManifestSpeechBrain(root_folder='/preproc/datasets/mms/mms_split_audio_segment/', 
                                                manifest_filename=f'/preproc/datasets/mms/mms_split_audio_segment/manifest_{lang}.json', 
                                                removed_dir='/preproc/datasets/mms/',
                                                replaced_dir='{root}/',
